...
$(document).ready(function () {
	...
	$('.service-pages__title').click(function (event) {
		$('.service-pages__title').toggleClass('active').next().slideToggle()
	});
	$('.site-menu__title').click(function (event) {
		$('.site-menu__title').toggleClass('active').next().slideToggle()
	});
	$('.write-to-us__title').click(function (event) {
		$('.write-to-us__title').toggleClass('active').next().slideToggle()
	});
});
